...
public class AdminProcessGenerator extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_admin_process_generator);
        ...
        ProgressDialog pd = new ProgressDialog(AdminProcessGenerator.this);
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                try{
                    ...
                    if (getLongitude != null && getLatitude != null && getWaterAvailability != null ){
                        ...
                        String[] expectedRockList = {"SandStone","unClassified", "Alluvium", "Basement Gneissic complex","Basalt", "Limestone","Laterite", "Schist"};
                        // Convert the random number to a String
                        ExpectedRock = expectedRockList[randomNumber4];
                        expectedRock.setText(ExpectedRock);

                        int randomNumber5 = random.nextInt(7 - 0 + 1) + 1;
                    ...
                    Toast.makeText(AdminProcessGenerator.this, ""+exception, Toast.LENGTH_SHORT).show();
                }
            }
        ...
        finishButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                databaseReference.child("Requests").child(RequestKey).child("status").setValue("Approved");

                pd.dismiss();
                Toast.makeText(AdminProcessGenerator.this, "Report created successfully!", Toast.LENGTH_SHORT).show();
