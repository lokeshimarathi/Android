...
public class MyPeopleRequestAdapter extends RecyclerView.Adapter<MyPeopleRequestAdapter.MyViewHolder> {
    private List<MyPeopleRequestList> peopleLists;
    private Context context;

    public MyPeopleRequestAdapter(List<MyPeopleRequestList> peopleLists, Context context) {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.my_people_request_adapter, parent, false);
        return new MyViewHolder(itemView);
    }

    @Override
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        MyPeopleRequestList list = peopleLists.get(position);
        ...
        holder.rootLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(context, MyPeopleRequestProfile.class);
    ...
    public void updateData(List<MyPeopleRequestList> peopleLists) {
        this.peopleLists = peopleLists;
