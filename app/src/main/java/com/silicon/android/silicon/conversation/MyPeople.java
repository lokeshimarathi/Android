 ...
 */
public class MyPeople extends Fragment {

    RecyclerView myPeopleRecyclerView;
    private MyPeopleAdapter myPeopleAdapter;
    private final List<MyPeopleList> myPeopleLists = new ArrayList<>();
    private String getKey;
    public MyPeople() {
        // Required empty public constructor
    }
    public static MyPeople newInstance() {
        return new MyPeople();
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        myPeopleAdapter = new MyPeopleAdapter(myPeopleLists, getContext());
        ...
        databaseReference.child("Users").child(AuthUserId).child("connection").addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                for (DataSnapshot snapshot1 : snapshot.getChildren()) {
                    ...
                    if (getKey != null && Objects.equals(getCondition, "connected")) {
                        pd.show();
                        databaseReference.child("Users").child(getKey).addListenerForSingleValueEvent(new ValueEventListener() {
                            ...
                            public void onDataChange(@NonNull DataSnapshot snapshot) {
                                ...
                                MyPeopleList myPeopletList = new MyPeopleList(getUserProfileImage, getUserName, getName, getGender, getKey);
                                myPeopleLists.add(myPeopletList);
